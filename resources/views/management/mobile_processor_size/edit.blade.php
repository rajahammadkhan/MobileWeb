...
@section('title')
        Processor Size Edit - {{ config('app.dashboard') }}
@endsection
@section('content')
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Processor Size</h4>
                            </li>

                        </ul>
                    </div>
                </div>
                <form action="{{route('mobile-processor-size.update',$size->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$size->name ?? '' }}" type="text"
                                    ...
                                    <div class="row my-2">
                                        <div class=" col-12">
                                            ...
                                            <textarea value="{{$size->description ?? '' }}" type="text" name="description"
