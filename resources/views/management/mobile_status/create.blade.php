...
@section('title')
        Mobile Status Create - {{ config('app.dashboard') }}
@endsection
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('mobile-status.index') }}"> Back</a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('mobile-status.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card py-4">
