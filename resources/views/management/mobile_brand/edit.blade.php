    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('mobile-brand.update',$brand->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card py-4">
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> Brand Name </strong></label>
                                            <div class="form-line">
                                                <input value="{{$brand->name ?? '' }}" type="text"
                                    ...
                                    <div class="row my-2">
                                        <div class=" col-12">
                                            <label for="email_address1">   <strong> Brand Description </strong></label>
                                            <textarea value="{{$brand->description ?? '' }}" type="text" name="description"
                                        ...
                                        <div class="col">
                                            <div class="main_container m-3">
                                                <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <input type="file" name="brand_image" accept=".jpg,.gif,.png,.webp"
                                                    ...
                                                    <div class="img-thumb">
                                                        ...
                                                        @else
                                                            <img class="main_img d-block w-100 h-100 position-absolute"
                                                                 src="{{asset('media/brand'.'/'.$brand->media->unique_name)}}"
                                                                 alt="">
                                                        @endif
                                                    </div>
                                                </div>
