...
@section('title')
    Mobile Category - {{ config('app.dashboard') }}
@endsection
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Mobile Category</h4>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="{{ route('mobile-category.create') }}" type="button" class="btn btn-primary"> Add
                                Category
                            </a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn bg-blue btn-circle"
                                               href="{{ route('mobile-category.edit', $row->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('mobile-category.destroy', $row->id) }}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')
